...
function initMap() {
  ...
  // https://docs.google.com/spreadsheets/d/1PcfwlB9O-2-9IScoJ1v7g_H4odJssRYw8rUEyycDSCw/edit?usp=sharing

  d3.csv("https://docs.google.com/spreadsheets/d/1PcfwlB9O-2-9IScoJ1v7g_H4odJssRYw8rUEyycDSCw/gviz/tq?tqx=out:csv&sheet=Map", (d) => {
    console.log(d);
    return {
      type: "Feature",
      properties: {
...
function markerStyle (category, feature) {
  ...
  } else if (feature.getProperty("marker") == "rental") {
